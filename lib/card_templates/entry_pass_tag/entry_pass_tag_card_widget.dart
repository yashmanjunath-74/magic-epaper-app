...
import 'entry_pass_tag_model.dart';
          ...
          children: [
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    data.venueName.isEmpty
                        ? appLocalizations.venueName
                  ...
                  Text(
                    data.visitorName.isEmpty ? '-' : data.visitorName,
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        data.passType.isEmpty ? '-' : data.passType,
                        style: TextStyle(
                          fontSize: 11,
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 4),
                      Text(
                        data.validDate.isEmpty ? '-' : data.validDate,
                        style: TextStyle(
                          fontSize: 11,
                          color: Colors.grey.shade700,
                          fontWeight: FontWeight.w500,
                  ...
                  Container(
                    ...
                    child: Text(
                      '${appLocalizations.passIdPrefix}${data.passId.isEmpty ? '-' : data.passId}',
                      style: TextStyle(
                        fontSize: 9,
                        color: Colors.grey.shade600,
